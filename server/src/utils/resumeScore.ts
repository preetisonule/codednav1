...
await parser.destroy();
  ...
  const sections = {
    education: /education|b\.?tech|bachelor|degree|university|college/i.test(
      text
    ),
    ...
    experience: /experience|internship|employment|work experience/i.test(
      text
    ),

    achievements: /achievement|awards|hackathon|competition/i.test(text),

    certifications: /certification|certifications|certificate/i.test(text),
  };
